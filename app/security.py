...
# Сколько сборок отчёта разрешаем с одного адреса в час. Восемнадцать ключей на прогон
# (бренд + 13 конкурентов + 4 симптоматики) — это ~$0.22, то есть потолок около $3 в час
# на адрес при лимите ниже.
REPORTS_PER_HOUR = 15
MAX_KEYWORDS = 24
