...
# Сколько сборок отчёта разрешаем с одного адреса в час. Полный прогон Гроприносина —
# 27 ключей (бренд + 13 конкурентов + 13 симптоматики), это ~$0.33, то есть потолок
# около $3.3 в час на адрес.
REPORTS_PER_HOUR = 10
MAX_KEYWORDS = 30
